...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dateo.link'
        db.add_column(u'dateo_dateo', 'link',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='dateos', null=True, to=orm['link.Link']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dateo.link'
        db.delete_column(u'dateo_dateo', 'link_id')
