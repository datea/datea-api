...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'image_image', 'image', self.gf('django_resized.forms.ResizedImageField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Image.image'
        db.alter_column(u'image_image', 'image', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))
    ...
    models = {
        ...
        u'image.image': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django_resized.forms.ResizedImageField', [], {'max_length': '100'}),
