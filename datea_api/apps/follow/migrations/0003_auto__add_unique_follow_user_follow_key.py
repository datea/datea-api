...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Follow', fields ['user', 'follow_key']
        db.create_unique(u'follow_follow', ['user_id', 'follow_key'])


    def backwards(self, orm):
        # Removing unique constraint on 'Follow', fields ['user', 'follow_key']
        db.delete_unique(u'follow_follow', ['user_id', 'follow_key'])
