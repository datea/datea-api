...
class Migration(DataMigration):
	...
	for img in orm['image.Image'].objects.all():
		
		new_img = orm.Image(user=img.user, image = img.image, order= img.order, width=img.width, height=img.height, client_domain=img.client_domain)
		new_img.save()		
