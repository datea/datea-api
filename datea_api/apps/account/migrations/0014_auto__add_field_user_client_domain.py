...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.client_domain'
        db.add_column(u'account_user', 'client_domain',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.client_domain'
        db.delete_column(u'account_user', 'client_domain')
