...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'account_user', 'vote_count')

        # Deleting field 'User.comment_count'
        db.delete_column(u'account_user', 'comment_count')

        # Adding field 'User.voted_count'
        db.add_column(u'account_user', 'voted_count',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'account_user', 'vote_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'User.comment_count'
        db.add_column(u'account_user', 'comment_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'User.voted_count'
        db.delete_column(u'account_user', 'voted_count')
