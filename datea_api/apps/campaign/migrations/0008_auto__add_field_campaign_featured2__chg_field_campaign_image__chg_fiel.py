...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Campaign.image'
        db.alter_column(u'campaign_campaign', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['image.Image']))

        # Changing field 'Campaign.category'
        db.alter_column(u'campaign_campaign', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['category.Category']))

        # Changing field 'Campaign.main_tag'
        db.alter_column(u'campaign_campaign', 'main_tag_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['tag.Tag']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Campaign.image'
        db.alter_column(u'campaign_campaign', 'image_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['image.Image']))

        # Changing field 'Campaign.category'
        db.alter_column(u'campaign_campaign', 'category_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['category.Category']))

        # Changing field 'Campaign.main_tag'
        db.alter_column(u'campaign_campaign', 'main_tag_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tag.Tag']))
    ...
    models = {
        ...
        u'campaign.campaign': {
            ...
            'featured2': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
