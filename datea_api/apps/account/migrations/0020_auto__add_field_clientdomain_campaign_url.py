...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClientDomain.campaign_url'
        db.add_column(u'account_clientdomain', 'campaign_url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClientDomain.campaign_url'
        db.delete_column(u'account_clientdomain', 'campaign_url')


    models = {
        u'account.clientdomain': {
            'Meta': {'object_name': 'ClientDomain'},
            'campaign_url': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
