...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.zoom'
        db.add_column(u'campaign_campaign', 'zoom',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=12),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.zoom'
        db.delete_column(u'campaign_campaign', 'zoom')
