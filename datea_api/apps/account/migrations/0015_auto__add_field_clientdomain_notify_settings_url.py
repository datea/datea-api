...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClientDomain.notify_settings_url'
        db.add_column(u'account_clientdomain', 'notify_settings_url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClientDomain.notify_settings_url'
        db.delete_column(u'account_clientdomain', 'notify_settings_url')
