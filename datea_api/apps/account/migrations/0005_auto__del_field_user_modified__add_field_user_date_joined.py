...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'account_user', 'modified')

        # Adding field 'User.date_joined'
        db.add_column(u'account_user', 'date_joined',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'User.modified'
        raise RuntimeError("Cannot reverse this migration. 'User.modified' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'User.modified'
        db.add_column(u'account_user', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True),
                      keep_default=False)

        # Deleting field 'User.date_joined'
        db.delete_column(u'account_user', 'date_joined')
