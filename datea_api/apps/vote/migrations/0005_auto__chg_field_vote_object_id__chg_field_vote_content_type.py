...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Vote.object_id'
        db.alter_column(u'vote_vote', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Vote.content_type'
        db.alter_column(u'vote_vote', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True))

    def backwards(self, orm):

        # Changing field 'Vote.object_id'
        db.alter_column(u'vote_vote', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=1))
        ...
        # Changing field 'Vote.content_type'
        db.alter_column(u'vote_vote', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType']))
    ...
    models = {
        ...
        u'vote.vote': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'votes'", 'to': u"orm['account.User']"}),
            'value': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'vote_key': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        }
    }
