...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'follow_follow', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Follow.content_type'
        db.alter_column(u'follow_follow', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Follow.object_id'
        raise RuntimeError("Cannot reverse this migration. 'Follow.object_id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Follow.object_id'
        db.alter_column(u'follow_follow', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')())

        # User chose to not deal with backwards NULL issues for 'Follow.content_type'
        raise RuntimeError("Cannot reverse this migration. 'Follow.content_type' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Follow.content_type'
        db.alter_column(u'follow_follow', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType']))
    ...
    models = {
        ...
        u'follow.follow': {
            'Meta': {'unique_together': "(('user', 'follow_key'),)", 'object_name': 'Follow'},
            'client_domain': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'follows'", 'to': u"orm['account.User']"})
        },
        u'image.image': {
