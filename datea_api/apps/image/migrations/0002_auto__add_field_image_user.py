...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'image_image', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='images', to=orm['account.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Image.user'
        db.delete_column(u'image_image', 'user_id')
