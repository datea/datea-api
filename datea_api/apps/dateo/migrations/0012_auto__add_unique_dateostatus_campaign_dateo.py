...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'DateoStatus', fields ['campaign', 'dateo']
        db.create_unique(u'dateo_dateostatus', ['campaign_id', 'dateo_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'DateoStatus', fields ['campaign', 'dateo']
        db.delete_unique(u'dateo_dateostatus', ['campaign_id', 'dateo_id'])
