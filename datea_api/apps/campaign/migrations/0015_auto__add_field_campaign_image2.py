...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.image2'
        db.add_column(u'campaign_campaign', 'image2',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='campaigns2', null=True, on_delete=models.SET_NULL, to=orm['image.Image']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.image2'
        db.delete_column(u'campaign_campaign', 'image2_id')
    ...
    models = {
        ...
        u'campaign.campaign': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'campaigns'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['image.Image']"}),
            'image2': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'campaigns2'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['image.Image']"}),
