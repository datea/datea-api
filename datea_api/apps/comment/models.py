...
class Comment(models.Model):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name='User', related_name='comments')
    ...
    #object_type = models.CharField('Object Name', max_length=50) # object typeid -> whatever
    object_id = models.PositiveIntegerField('Object id') # object id
