...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'link_link', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='links', to=orm['account.User'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=255)),
            ('img_url', self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True)),
