...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tag.follow_count'
        db.add_column(u'tag_tag', 'follow_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Tag.dateo_count'
        db.add_column(u'tag_tag', 'dateo_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tag.follow_count'
        db.delete_column(u'tag_tag', 'follow_count')

        # Deleting field 'Tag.dateo_count'
        db.delete_column(u'tag_tag', 'dateo_count')
