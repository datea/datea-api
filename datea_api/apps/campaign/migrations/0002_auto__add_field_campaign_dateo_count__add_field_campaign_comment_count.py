...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.dateo_count'
        db.add_column(u'campaign_campaign', 'dateo_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Campaign.comment_count'
        db.add_column(u'campaign_campaign', 'comment_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Campaign.follow_count'
        db.add_column(u'campaign_campaign', 'follow_count',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.dateo_count'
        db.delete_column(u'campaign_campaign', 'dateo_count')

        # Deleting field 'Campaign.comment_count'
        db.delete_column(u'campaign_campaign', 'comment_count')

        # Deleting field 'Campaign.follow_count'
        db.delete_column(u'campaign_campaign', 'follow_count')
