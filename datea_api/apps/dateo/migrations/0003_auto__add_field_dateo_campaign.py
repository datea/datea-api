...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dateo.campaign'
        db.add_column(u'dateo_dateo', 'campaign',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='dateos', null=True, to=orm['campaign.Campaign']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dateo.campaign'
        db.delete_column(u'dateo_dateo', 'campaign_id')
