...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'tag_tag', 'tag', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=100))

    def backwards(self, orm):

        # Changing field 'Tag.tag'
        db.alter_column(u'tag_tag', 'tag', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))
