...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Tag.has_images'
        db.delete_column(u'tag_tag', 'has_images')

        # Adding field 'Tag.num_images'
        db.add_column(u'tag_tag', 'num_images',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Tag.has_images'
        db.add_column(u'tag_tag', 'has_images',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Tag.num_images'
        db.delete_column(u'tag_tag', 'num_images')
