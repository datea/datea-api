...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'account_user', 'created')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'User.created'
        raise RuntimeError("Cannot reverse this migration. 'User.created' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'User.created'
        db.add_column(u'account_user', 'created',
