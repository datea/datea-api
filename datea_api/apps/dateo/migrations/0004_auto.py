...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field images on 'Dateo'
        m2m_table_name = db.shorten_name(u'dateo_dateo_images')
        ...
        db.create_unique(m2m_table_name, ['dateo_id', 'image_id'])


    def backwards(self, orm):
        # Removing M2M table for field images on 'Dateo'
        db.delete_table(db.shorten_name(u'dateo_dateo_images'))
