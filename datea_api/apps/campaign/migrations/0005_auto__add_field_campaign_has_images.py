...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.has_images'
        db.add_column(u'campaign_campaign', 'has_images',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.has_images'
        db.delete_column(u'campaign_campaign', 'has_images')
    ...
    models = {
        ...
        u'campaign.campaign': {
            ...
            'has_images': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
