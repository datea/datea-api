...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Redateo'
        db.create_table(u'dateo_redateo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['account.User'])),
            ('dateo', self.gf('django.db.models.fields.related.ForeignKey')(related_name='redateos', to=orm['dateo.Dateo'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'dateo', ['Redateo'])

        # Adding unique constraint on 'Redateo', fields ['user', 'dateo']
        db.create_unique(u'dateo_redateo', ['user_id', 'dateo_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Redateo', fields ['user', 'dateo']
        db.delete_unique(u'dateo_redateo', ['user_id', 'dateo_id'])

        # Deleting model 'Redateo'
        db.delete_table(u'dateo_redateo')
