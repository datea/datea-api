...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.default_vis'
        db.add_column(u'campaign_campaign', 'default_vis',
                      self.gf('django.db.models.fields.CharField')(default='map', max_length=10),
                      keep_default=False)

        # Adding field 'Campaign.default_filter'
        db.add_column(u'campaign_campaign', 'default_filter',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.default_vis'
        db.delete_column(u'campaign_campaign', 'default_vis')

        # Deleting field 'Campaign.default_filter'
        db.delete_column(u'campaign_campaign', 'default_filter')
