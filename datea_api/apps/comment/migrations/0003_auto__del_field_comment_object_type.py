...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'comment_comment', 'object_type')


    def backwards(self, orm):
        # Adding field 'Comment.object_type'
        db.add_column(u'comment_comment', 'object_type',
                      self.gf('django.db.models.fields.CharField')(default='dateo', max_length=50),
                      keep_default=False)
