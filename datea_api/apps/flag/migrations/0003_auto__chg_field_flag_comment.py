...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Flag.comment'
        db.alter_column(u'flag_flag', 'comment', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Flag.comment'
        db.alter_column(u'flag_flag', 'comment', self.gf('django.db.models.fields.TextField')(default=''))
    ...
    models = {
        ...
        u'flag.flag': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'flags'", 'to': u"orm['account.User']"})
        },
        u'image.image': {
