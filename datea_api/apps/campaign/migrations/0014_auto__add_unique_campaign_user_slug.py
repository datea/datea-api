...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Campaign', fields ['user', 'slug']
        db.create_unique(u'campaign_campaign', ['user_id', 'slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Campaign', fields ['user', 'slug']
        db.delete_unique(u'campaign_campaign', ['user_id', 'slug'])
