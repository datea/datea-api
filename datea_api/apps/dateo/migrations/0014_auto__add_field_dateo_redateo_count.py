...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dateo.redateo_count'
        db.add_column(u'dateo_dateo', 'redateo_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dateo.redateo_count'
        db.delete_column(u'dateo_dateo', 'redateo_count')
