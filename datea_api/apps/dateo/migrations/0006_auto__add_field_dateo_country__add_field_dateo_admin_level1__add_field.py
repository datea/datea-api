...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Dateo.country'
        db.add_column(u'dateo_dateo', 'country',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Dateo.admin_level1'
        db.add_column(u'dateo_dateo', 'admin_level1',
                      self.gf('django.db.models.fields.CharField')(max_length=127, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Dateo.admin_level2'
        db.add_column(u'dateo_dateo', 'admin_level2',
                      self.gf('django.db.models.fields.CharField')(max_length=127, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Dateo.admin_level3'
        db.add_column(u'dateo_dateo', 'admin_level3',
                      self.gf('django.db.models.fields.CharField')(max_length=127, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Dateo.country'
        db.delete_column(u'dateo_dateo', 'country')

        # Deleting field 'Dateo.admin_level1'
        db.delete_column(u'dateo_dateo', 'admin_level1')

        # Deleting field 'Dateo.admin_level2'
        db.delete_column(u'dateo_dateo', 'admin_level2')

        # Deleting field 'Dateo.admin_level3'
        db.delete_column(u'dateo_dateo', 'admin_level3')
