...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Follow.client_domain'
        db.add_column(u'follow_follow', 'client_domain',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Follow.client_domain'
        db.delete_column(u'follow_follow', 'client_domain')
