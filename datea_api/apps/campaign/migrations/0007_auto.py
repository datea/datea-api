...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field kmlfiles on 'Campaign'
        db.delete_table(db.shorten_name(u'campaign_campaign_kmlfiles'))

        # Adding M2M table for field layer_files on 'Campaign'
        m2m_table_name = db.shorten_name(u'campaign_campaign_layer_files')
        ...
        db.create_unique(m2m_table_name, ['campaign_id', 'file_id'])


    def backwards(self, orm):
        # Adding M2M table for field kmlfiles on 'Campaign'
        m2m_table_name = db.shorten_name(u'campaign_campaign_kmlfiles')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('campaign', models.ForeignKey(orm[u'campaign.campaign'], null=False)),
            ('file', models.ForeignKey(orm[u'file.file'], null=False))
        ...
        # Removing M2M table for field layer_files on 'Campaign'
        db.delete_table(db.shorten_name(u'campaign_campaign_layer_files'))
