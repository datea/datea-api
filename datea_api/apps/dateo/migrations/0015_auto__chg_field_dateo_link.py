...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Dateo.link'
        db.alter_column(u'dateo_dateo', 'link_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['link.Link']))

    def backwards(self, orm):

        # Changing field 'Dateo.link'
        db.alter_column(u'dateo_dateo', 'link_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['link.Link']))
